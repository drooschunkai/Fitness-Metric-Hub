    ...
    <div className="space-y-12 py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto animate-in fade-in duration-300" id="guides-page-root">
      ...
      <div className="bg-slate-50 dark:bg-gray-900/50 border border-slate-200 dark:border-gray-800 p-6 rounded-2xl space-y-4 shadow-xs" id="search-filter-dock">
        <div className="flex flex-col xl:flex-row gap-4 items-center justify-between">
          ...
          {/* Category tabs */}
          <div className="flex flex-wrap gap-1 bg-slate-200/50 dark:bg-gray-950 p-1 border border-slate-200/50 dark:border-gray-800 rounded-lg w-full xl:w-auto overflow-x-auto justify-start xl:justify-end">
