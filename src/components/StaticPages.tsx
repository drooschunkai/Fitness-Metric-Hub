    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 space-y-12 animate-in fade-in duration-300" id="about-page">
      ...
      {onNavigate && (
        <div className="bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-800 rounded-2xl p-8 text-center space-y-4">
          <h2 className="text-xl font-bold text-gray-950 dark:text-white">Have Questions or Feedback?</h2>
      ...
      <section className="bg-white dark:bg-gray-950 border border-slate-200 dark:border-gray-800 rounded-2xl p-8 shadow-sm">
        {submitted ? (
          <div className="p-6 bg-emerald-50 border border-emerald-100 rounded-2xl text-center space-y-2">
            ...
            <h2 className="font-bold text-emerald-950">Message Sent Successfully!</h2>
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8 space-y-6 animate-in fade-in duration-300" id="privacy-page">
      <div className="border-b pb-4">
        ...
        <p className="text-xs text-slate-500 dark:text-gray-400 mt-1.5">Last updated: June 23, 2026</p>
      </div>
      ...
      <div className="prose prose-sm max-w-none text-gray-600 dark:text-gray-400 space-y-4 text-justify leading-relaxed">
        ...
        <h2 className="text-lg font-bold text-gray-950 dark:text-white pt-2">1. Log Files & Analytics</h2>
        <p>
          FitMetricsHub follows a standard procedure of using log files. These files log visitors when they visit websites. The information collected by log files includes internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable.
        </p>

        <h2 className="text-lg font-bold text-gray-950 dark:text-white pt-2">2. Google DoubleClick DART Cookies & AdSense Policies</h2>
        <p>
          Google is one of the third-party vendors on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to www.website.com and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL: <a href="https://policies.google.com/technologies/ads" className="text-emerald-700 dark:text-emerald-400 underline font-semibold">https://policies.google.com/technologies/ads</a>.
        </p>

        <h2 className="text-lg font-bold text-gray-950 dark:text-white pt-2">3. Our Advertising Partners</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-gray-950 dark:text-white pt-2">4. Children's Information</h2>
        <p>
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8 space-y-6 animate-in fade-in duration-300" id="terms-page">
      ...
      <div className="prose prose-sm max-w-none text-gray-600 dark:text-gray-400 space-y-4 text-justify leading-relaxed">
        ...
        <h2 className="text-lg font-bold text-gray-950 dark:text-white pt-2">1. License & Permitted Use</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-gray-950 dark:text-white pt-2">2. Intellectual Property Rights</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-gray-950 dark:text-white pt-2">3. Limitation of Liability</h2>
        <p>
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8 space-y-6 animate-in fade-in duration-300" id="disclaimer-page">
      <div className="border-b pb-4">
        ...
        <p className="text-xs text-slate-500 dark:text-gray-400 mt-1.5">Required health notice and clinical guidelines</p>
      </div>
      ...
      <div className="prose prose-sm max-w-none text-gray-600 dark:text-gray-400 space-y-4 text-justify leading-relaxed">
        ...
        <h2 className="text-lg font-bold text-gray-950 dark:text-white pt-2">1. Not Medical Advice</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-gray-950 dark:text-white pt-2">2. No Patient-Physician Relationship</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-gray-950 dark:text-white pt-2">3. Accuracy of Mathematical Formulas</h2>
        <p>
